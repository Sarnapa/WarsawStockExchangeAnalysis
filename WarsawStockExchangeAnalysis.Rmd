...
# Pokazujemy statystyki dla wybranych okresów
all_instruments_charts_periods_stats_df <- all_instruments_stats_df %>% filter(Years %in% charts_periods)
...
visualize_all_instruments_stats_chart <- function(y_param, title, subtitle, y_lab) {
  ggplot(all_instruments_charts_periods_stats_df, aes(x = Years, y = y_param, fill = Instrument)) +
...
visualize_all_instruments_stats_chart(all_instruments_charts_periods_stats_df$CumulativeReturnRate, "Skumulowana stopa zwrotu dla wybranych okresów inwestycji", "kończących się w roku 2024", "Skumulowana stopa zwrotu [%]")
```
...
---
```{r, echo = FALSE, fig.width = 10, fig.height = 6}
visualize_all_instruments_stats_chart(all_instruments_charts_periods_stats_df$AnnualReturnRateSd, "Odchylenie standardowe rocznej stopy zwrotu dla wybranych okresów inwestycji", "kończących się w roku 2024", "Odchylenie standardowe rocznej stopy wzrostu [%]")
```
