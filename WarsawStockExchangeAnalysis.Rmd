...
fund3401_ar_df <- calculate_annual_returns(fund3401_df)
fund4438_ar_df <- calculate_annual_returns(fund4438_df)
fund4502_ar_df <- calculate_annual_returns(fund4502_df)
```
...
fund3401_stats_df <- map_dfr(periods, ~get_stats_for_period(instruments[2], fund3401_ar_df, .x))
fund4438_stats_df <- map_dfr(periods, ~get_stats_for_period(instruments[3], fund4438_ar_df, .x))
fund4502_stats_df <- map_dfr(periods, ~get_stats_for_period(instruments[4], fund4502_ar_df, .x))
