...
subtitle: "Jest to bardziej ryzykowne niż skorzystanie z usług funduszy inwestycyjnych"
...
```{r, echo=FALSE, fig.width=10, fig.height=6}
ggplot(all_instruments_stats_df, aes(x = Years, y = AnnualReturnRateSd, fill = Instrument)) +
  geom_col(position = "dodge") +
  labs(
    title = "Odchylenie standardowe rocznej stopy wzrostu dla różnych okresów inwestycji",
    subtitle = "kończących się w roku 2024",
    x = "Okres inwestycji w latach",
    y = "Odchylenie standardowe rocznej stopy wzrostu",
    fill = "Instrument"
  )
```

Powyższy wykres pokazuje wyraźnie, że indeks WIG mierzący zyski z inwestycji na giełdzie posiada największe odchylenie rocznej stopy wzrostu dla wszystkich rozważanych czasów inwestycji. Oznacza to, że w przypadku bezpośredniego inwestowania na giełdzie istnieje większe ryzyko poniesienia straty w porównaniu do funduszy inwestycyjnych, podczas gdy średni zysk jest podobny, a nawet nieco mniejszy.
---
